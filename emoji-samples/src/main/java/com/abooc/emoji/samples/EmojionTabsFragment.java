...
import static com.abooc.emoji.samples.EmojionTabsFragment.Tabs.ADD;
import static com.abooc.emoji.samples.EmojionTabsFragment.Tabs.EMOJICON;
import static com.abooc.emoji.samples.EmojionTabsFragment.Tabs.GIFTS;
...
public class EmojionTabsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(com.abooc.emoji.R.id.emojicons_menu_add).setOnClickListener(this);
        view.findViewById(com.abooc.emoji.R.id.emojicons_menu_emojicon).setOnClickListener(this);
        view.findViewById(com.abooc.emoji.R.id.emojicons_menu_gifts).setOnClickListener(this);
        view.findViewById(com.abooc.emoji.R.id.emojicons_menu_settings).setOnClickListener(this);
    }
